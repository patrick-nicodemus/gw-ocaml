...
struct futhark_f64_1d *futhark_new_raw_f64_1d(struct futhark_context *ctx, CUdeviceptr data, int64_t offset, int64_t dim0);
...
struct futhark_f64_2d *futhark_new_raw_f64_2d(struct futhark_context *ctx, CUdeviceptr data, int64_t offset, int64_t dim0, int64_t dim1);
...
struct futhark_f64_3d *futhark_new_raw_f64_3d(struct futhark_context *ctx, CUdeviceptr data, int64_t offset, int64_t dim0, int64_t dim1, int64_t dim2);
